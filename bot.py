...
LOCATION_HOUSES = {
    ...
    {
        "id": "elovka_1",
        "button": "Простор 105 кв.м на 7,1 сотках — 6,8 млн ₽",
        "photo": "https://disk.yandex.ru/i/A1RTaAUzHsEtGA",
        "caption": (
            "🏡 <b>Простор 105 м²</b>\n\n"
            "📍 <b>Локация:</b> Еловка\n"
            "🗺 <a href='https://yandex.ru/maps/-/CLhHM0OV'>Посмотреть на карте</a>\n\n"

            "📐 <b>Площадь дома:</b> 105 м²\n"
            "🌿 <b>Участок:</b> 7,1 сотки\n\n"
            ...
            "💰 <b>Стоимость:</b> 6 800 000 ₽"
        ),
        "media_url": "https://disk.yandex.ru/d/vui_PX9OBXkIbw"
    }
],
    "Сивково": [],
    "Некрасово": [],
